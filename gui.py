...
from utilities.df_functions import check_col_datatypes,st_show_datatypes,st_show_nullvalues, filter_tv_rows,st_show_head
    ...
    if options == "Data Cleaning":
        ...
        if not data_frame.empty:
            ...
            if st.session_state.clean_columns:
                progress_bar()
                anime_df = check_col_datatypes(dataFrame = anime_df)
            ...
            # if st.button('Null Values Check'):
            #     anime_df = check_col_datatypes(dataFrame = anime_df) #TODO: Diksha 
